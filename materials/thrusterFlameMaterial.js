...
const FRAGMENT_SHADER = `
  ...
  uniform float uPerpScrollSpeed;
...
void main() {
  ...
  t * uNoiseScale * uHorizontalStretch + uTime * uPerpScrollSpeed * uNoiseScale,
  scrolledV * uNoiseScale * uVerticalStretch
);
...
export function makeThrusterMaterial(overrides = {}) {
  const cfg = {
    scrollSpeed: 0,
    perpScrollSpeed: 0.0, 
    ...
    noiseScale: 12.0,
    verticalStretch: 0.8,   // lower = more stretched/elongated streaks
    horizontalStretch: 0.2,     
  ...
  return new THREE.ShaderMaterial({
    uniforms: {
      ...
      uPerpScrollSpeed: { value: cfg.perpScrollSpeed },
      uHorizontalStretch: { value: cfg.horizontalStretch },
    },
