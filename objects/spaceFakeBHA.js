...
import { makeAccretionDiskMaterial } from '../materials/accretionDiskMaterial.js';

const CONFIG = {
  path: './3d_model/SpaceFakeBlackHoleDisk.glb',
  scale: 0.5,
  diskOptions: {}, // pass overrides here if you want to retune colors/speed
};

export function addSpaceFakeBlackHoleDisk(scene, overrides = {}) {
  const cfg = { ...CONFIG, ...overrides };
  const material = makeAccretionDiskMaterial(cfg.diskOptions);
